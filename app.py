...
st.title("DataBurn — Monitoramento Espacial Activo")
st.caption("Sistema de Visibilidade e Inteligência Geográfica contra Incêndios Florestais")

# Barra Lateral com os RMs de toda a equipe
with st.sidebar:
    ...
    st.markdown("- **Bernardo Rocha** — RM 99209")
    st.markdown("- **Eric Carvalho** — RM 550249")
    st.markdown("- **Manoella Waideman** — RM 98906")
    st.markdown("- **Renato Ichikawa** — RM 99242")
    st.markdown("- **Victor Hugo Andrade** — RM 550996")
...
# Seção 2: O Dashboard Técnico de Simulação
...
with col_data:
    ...
    alert_logs = pd.DataFrame({
        ...
        'Nível de Alerta': ['Crítico', 'Moderado', 'Crítico', 'Controlado']
    })
